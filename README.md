...
2) Convert your CI/CD pipelines from one format to another, for example from Jenkins to github actions, TeamCity to Jenkins,  Shell or SQL to Airflow DAGs, etc.
3) Validate any CI/CD pipeline from input  
